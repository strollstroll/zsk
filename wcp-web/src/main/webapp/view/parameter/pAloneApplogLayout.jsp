			...
			<table id="dataLogGrid">
				<thead>
					<tr>
						...
						<th field="DESCRIBES" data-options="sortable:true" width="120">
							日志
						</th>
						<th field="LEVELS" data-options="sortable:true" width="30">
							日志级别
						</th>
						<th field="APPUSER" data-options="sortable:true" width="45">
							操作人
						</th>
						<th field="CLASSNAME" data-options="sortable:true" width="50">
							对象名
						</th>
						<th field="METHOD" data-options="sortable:true" width="50">
							操作入口
						</th>
						<th field="IP" data-options="sortable:true" width="55">
							IP
						</th>
						<th field="CTIME" data-options="sortable:true" width="55">
							生成时间
						</th>
					</tr>
				</thead>
