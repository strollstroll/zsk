				...
				<tr>
					...
					<td colspan="2">
						<input type="text" style="width: 360px;"
							class="easyui-validatebox"
							data-options="required:true,validType:[,'maxLength[32]']"
							id="entity_name" value="${entity.name}">
				...
				<tr>
					...
					<td>
						<input type="text" style="width: 360px;"
							...
							id="entity_len" value="${entity.len}">
					</td>
					<td class="title">
						扩展名:
					</td>
					<td>
						<input type="text" style="width: 360px;"
							...
							id="entity_exname" value="${entity.exname}">
					</td>
				</tr>
				<tr>
					<td class="title">
					...
					<td>
						...
						<select id="entity_type" val="${entity.type}">
							<option value="1">
								图片
							</option>
							<option value="0">
					...
					<td>
						<select id="entity_pstate" val="${entity.pstate}">
							<option value="1">
								使用
							</option>
							<option value="0">
				...
				<tr>
					...
					<td colspan="3">
						<input type="text" style="width: 360px;"
							...
							id="entity_dir" value="${entity.dir}">
					</td>
				</tr>
