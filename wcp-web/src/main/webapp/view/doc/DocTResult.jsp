				...
				<table id="dataFarmdocGrid">
					<thead>
						<tr>
							...
							<th field="PUBTIME" data-options="sortable:true" width="30">
								发布时间
							</th>
							<th field="STATE" data-options="sortable:true" width="15">
								状态
							</th>
							<th field="READPOP" data-options="sortable:true" width="15">
								读权限
							</th>
							<th field="WRITEPOP" data-options="sortable:true" width="15">
								写权限
							</th>
							<th field="DOMTYPE" data-options="sortable:true" width="20">
								内容类型
							</th>
							<th field="GROUPNAME" data-options="sortable:true" width="30">
								所属小组
							</th>
						</tr>
					</thead>
