			...
			<table id="dataDocfileGrid">
				<thead>
					<tr>
						...
						<th field="NAME" data-options="sortable:true" width="170">
							显示名称
						</th>
						<th field="TYPE" data-options="sortable:true" width="55">
							类型
						</th>
						<th field="EXNAME" data-options="sortable:true" width="55">
							扩展名
						</th>
						<th field="LEN" data-options="sortable:true" width="70">
							文件大小(b)
						</th>
						<th field="FILENAME" data-options="sortable:true" width="190">
							文件名
						</th>
						<th field="DIR" data-options="sortable:true" width="75">
							目录
						</th>
						<th field="PSTATE" data-options="sortable:true" width="60">
							状态
						</th>
					</tr>
				</thead>
