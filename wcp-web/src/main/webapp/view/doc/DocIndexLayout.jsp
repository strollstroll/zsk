...
<body class="easyui-layout">
	...
	<div data-options="region:'center',border:false">
		<table class="easyui-datagrid" id="dom_datagridfarmdoc">
			...
			<thead>
				<tr>
					<th field="READPOP" data-options="sortable:true" width="70">
						浏览权限</th>
					<th field="WRITEPOP" data-options="sortable:true" width="70">
						修改权限</th>
					<th field="AUTHOR" data-options="sortable:true" width="110">
						作者</th>
					<th field="PUBTIME" data-options="sortable:true" width="120">
						发布时间</th>
