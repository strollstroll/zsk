			...
			<div class="row">
				<c:forEach var="topDoc" items="${topDocList}">
					<div class="col-md-6" style="min-height: 310px;">
						<div class="doc_node_max_title" style="max-height: 42px;overflow: hidden;">
							<a class="doc_node_max_title" style="font-size: 22px;"
						...
						<div class="doc_node_content">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ${topDoc.text } &nbsp;</div>
					</div>
				</c:forEach>
			</div>
		</div>
