...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation"
	...
	<%-- 	<a class="navbar-brand"
			style="font-size:35px;color: #ffffff; font-weight: bold; padding: 11px 5px 11px 5px;"
			href="<DOC:defaultIndexPage/>">  <img
			src="<PF:basePath/>/text/img/logo_bw.png" height="40" alt="WCP"
			title="WCP" align="middle" /> 
			知识库
		</a> --%>
			<a class="navbar-brand"
			style="font-size:35px;color: #ffffff; font-weight: bold; padding: 5px;"
			href="<DOC:defaultIndexPage/>">  <img
			src="<PF:basePath/>/text/img/logo_head.png" height="40" alt="WCP"
			title="WCP" align="middle" />
	...
	<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		<ul class="nav navbar-nav">
			...
			<c:if test="${USEROBJ.type==3}">
			 <li class="active"><a href="webstat/PubHome.html"><span
					class="glyphicon glyphicon-stats"></span>&nbsp;荣誉</a></li></c:if>
		...
		<ul class="nav navbar-nav navbar-right" style="margin-right: 10px;">
			<li class="active"><a href="http://101.71.130.86:8001/login.thtml"><span
						class="glyphicon glyphicon-pencil"></span>&nbsp;考试</a></li>
			<c:if test="${USEROBJ.type==3}">
				<li class="active"><a href="frame/index.do"><span
						class="glyphicon glyphicon-asterisk"></span>&nbsp;管理控制台</a></li>
			</c:if>
			<c:if test="${USEROBJ==null}">
				<li class="active"><a href="login/webPage.html"><span
						class="glyphicon glyphicon glyphicon-user"></span>&nbsp;登录<%-- <PF:IfParameterEquals
							key="config.sys.registable" val="true">/注册</PF:IfParameterEquals> --%></a></li>
			</c:if>
			<c:if test="${USEROBJ!=null}">
