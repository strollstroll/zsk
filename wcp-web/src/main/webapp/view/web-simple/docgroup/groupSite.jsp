					...
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<div class="bg-success">
								<small>小组成立于</small> <strong> <PF:FormatTime
											date="${docgroup.ctime}" yyyyMMddHHmmss="yyyy-MM-dd HH:mm" />
								</strong> <small>,有成员</small> <strong> ${docgroup.usernum}
								</strong> <small>人,共发布文档</small> <strong> ${docnum}
