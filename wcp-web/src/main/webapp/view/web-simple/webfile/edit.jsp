							...
							<div class="col-md-12">
								<div class="form-group">
									<label for="exampleInputEmail1"> 标签 </label> <input
										...
										placeholder="输入类别标签，多个标签间用英文逗号或空格分割(如果没有系统将自动创建)" />
								</div>
							</div>
						</div>
						<!-- remyxo, 2017-12-07 -->
									...
									<div class="row">
										<div class="col-md-12">
											<input type="button" id="uploadImgButton"
												...
												style="padding: 0px; padding-bottom: 8px;" value="上传内容图" />
											<input type="hidden" id="imgFileId" name="imgFileId" value="${doce.doc.imgid }">
...
<script type="text/javascript">
	...
	$("#showImg").attr("data-content", '<img class="img-thumbnail center-block" alt="内容图" src="actionImg/Publoadfile.do?id=${doce.doc.imgid }">')
	...
	.ready(function(K) {
		var uploadbutton = K
				.uploadbutton({
					...
					afterUpload : function(data) {
						if (data.error === 0) {
							$("#showImg").attr("data-content", '<img class="img-thumbnail center-block"  style="width:270px;" alt="内容图" src="actionImg/Publoadfile.do?id='+data.id+'">');
