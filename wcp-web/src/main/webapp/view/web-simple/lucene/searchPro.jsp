		...
		<div class="container ">
			...
			<div class="row">
				...
				<div class="col-sm-6 " style="margin: auto;">
					...
					<div class="panel panel-default  side_column">
						<div class="panel-body searchtypebox" id="typeidsbox"> <!-- daijd, add searchtypebox -->
							<ul class="doctypeUl">
...
<script type="text/javascript">
	$(function() {
		// remyxo, 2017-10-20, moved from line 48
	...
	// remyxo, 2017-10-20, added from v3.4.0-free
	function initTypesStyle(){
		$(".searchtypebox input[type='checkbox']").bind('click', function() {
