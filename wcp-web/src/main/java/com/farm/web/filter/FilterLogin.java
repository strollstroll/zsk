...
public class FilterLogin extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        // 不过滤的uri
        String[] notFilter = new String[] { "login","login.jsp","/wcp/login/webPage.html", "index.jsp","view/web-simple/atext"
        		,"text"};
        ...
        if (uri.indexOf("wcp") != -1) {
            ...
            if (doFilter) {
                ...
                if (null == obj) {
                    ...
                    String loginPage = "/wcp/login/webPage.html";
