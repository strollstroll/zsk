...
public class WcpAppImpl extends UnicastRemoteObject implements WcpAppInter {
	...
	private FarmFileManagerInter farmFileManagerImpl = (FarmFileManagerInter) BeanFactory.getBean("farmFileManagerImpl");
	...
	public String creatHTMLKnow(String knowtitle, String knowtypeId, String text, String knowtag, String currentUserId)
		...
		DocEntire doc = null;
		try {
			doc = KnowServiceImpl.creatKnow(knowtitle, knowtypeId, text, knowtag, POP_TYPE.PUB, POP_TYPE.PUB, null, null,
					null);
		} catch (Exception e) {
