...
public class FarmDocManagerImpl implements FarmDocManagerInter {
	...
	@Resource
	private FarmDocRelationDaoInter farmDocRelationDao;   // remyxo, 2017-11-01
