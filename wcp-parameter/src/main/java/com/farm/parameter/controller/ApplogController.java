...
public class ApplogController {
	...
	public Map<String, Object> queryall(DataQuery query,
		...
		try {
			...
			// remyxo, 2017-12-13, n b.id=a.APPUSER is wrong !!!
			/*
			query = DataQuery
					.init(query,
			...
			*/
			query = DataQuery.init(query,
							"alone_applog a",
							"a.id as id,a.CTIME as ctime,a.DESCRIBES as describes,a.appuser as appuser,a.LEVELS as levels,a.METHOD as method,a.CLASSNAME as classname,a.IP as ip");
			// end, 2017-12-13
